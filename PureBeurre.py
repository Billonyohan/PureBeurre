...
class tkinterWindow:
    ...
    def second_frame(self, frame):
        ...
        button_subsitute = tk.Button(frame, text="Historique", command=tkinterW.third_window, bg="#FAFAFA").grid(row=28, column=6, sticky=E)
    ...
    def substitute_food_saved(self):
        ...
        if len(select.nutriscore_substitute_saved(index)) > 0:
            ...
            ingredients_substitute = tk.Label(self.third_window, text=select.ingredients_substitute_saved(index)[0], wraplength=350, bg="#FAFAFA")
            ...
            store_substitute = tk.Label(self.third_window, text=select.store_substitute_saved(index)[0], wraplength=350, bg="#FAFAFA").grid(row=15, column=0, columnspan=2, sticky=N+S+E+W)
            ...
            link_substitute = tk.Label(self.third_window, text=select.link_substitute_saved(index)[0], wraplength=350, bg="#FAFAFA").grid(row=18, column=0, columnspan=2, sticky=N+S+E+W)
            space = tk.Label(self.third_window, text="            ", bg="#CECECE"). grid(row=11, column=3)
            label_food = tk.Label(self.third_window, text=select.food_save(index)[0], bg="#9E9E9E").grid(row=0, column=4, columnspan=2, sticky=N+S+E+W)
            ...
            description_food = tk.Label(self.third_window, text=select.ingredients_food_saved(index)[0], wraplength=350, bg="#FAFAFA").grid(row=2, column=4, rowspan=10, columnspan=2, sticky=N+S+E+W)
            ...
            store_food = tk.Label(self.third_window, text=select.store_food_saved(index)[0], wraplength=350, bg="#FAFAFA").grid(row=15, column=4, columnspan=2, sticky=N+S+E+W)
            ...
            link_food = tk.Label(self.third_window, text=select.link_food_saved(index)[0], wraplength=350, bg="#FAFAFA").grid(row=18, column=4, columnspan=2, sticky=N+S+E+W)
