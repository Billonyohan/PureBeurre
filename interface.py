...
def substitute_food():
	...
	label_subsitute = tk.Label(third_window, text = "Aliments : ", bg="#9E9E9E").grid(row=0, column=0)
	...
	data_susbstitute = cursor.fetchall()
	data_susbstitute = [d[0] for d in data_susbstitute]
	data_ingredients_susbstitute = tk.Label(third_window, text= data_susbstitute, wraplength=350, bg="#FAFAFA").grid(row=2, column=1, columnspan=2, sticky=N+S+E+W)
	description_susbtitute = tk.Label(third_window, text= "  ", wraplength=350, bg="#FAFAFA").grid(row=3, column=1, columnspan=2, sticky=N+S+E+W)
	cursor.execute("SELECT store FROM substitute WHERE id ="+index_substitute_save[i])
	data_susbstitute = cursor.fetchall()
	data_susbstitute = [d[0] for d in data_susbstitute]
	data_store_susbtitute = tk.Label(third_window, text= data_susbstitute, wraplength=350, bg="#FAFAFA").grid(row=3, column=1, columnspan=2, sticky=N+S+E+W)
	space_column= tk.Label(third_window, text= "  ", wraplength=350, bg="#FAFAFA").grid(row=4, column=1, columnspan=2, sticky=N+S+E+W)
	cursor.execute("SELECT link FROM substitute WHERE id ="+index_substitute_save[i])
	data_susbstitute = cursor.fetchall()
	data_susbstitute = [d[0] for d in data_susbstitute]
	data_link_susbtitute = tk.Label(third_window, text= data_susbstitute, wraplength=350, bg="#FAFAFA").grid(row=5, column=1, columnspan=2, sticky=N+S+E+W)
	...
	label_food = tk.Label(third_window, text= data_food, bg="#9E9E9E").grid(row=0, column=4, columnspan=2, sticky=N+S+E+W)
	...
	description_food = tk.Label(third_window, text= data_ingredients, wraplength=350, bg="#FAFAFA").grid(row=2, column=4, rowspan=10, columnspan=2, sticky=N+S+E+W)
...
def get_substitute():
	...
	if get_index == 1:
		...
		data_susbstitute = cursor.fetchall()
		data_susbstitute = [d[0] for d in data_susbstitute]
		data_ingredients_susbstitute = tk.Label(second_window, text= data_susbstitute, wraplength=350, bg="#FAFAFA").grid(row=4, column=6, columnspan=2, sticky=N+S+E+W)
		...
		data_susbstitute = cursor.fetchall()
		data_susbstitute = [d[0] for d in data_susbstitute]
		data_store_susbtitute = tk.Label(second_window, text= data_susbstitute, wraplength=350, bg="#FAFAFA").grid(row=6, column=6, columnspan=2, sticky=N+S+E+W)
		space_column= tk.Label(second_window, text= "  ", wraplength=350, bg="#FAFAFA").grid(row=7, column=6, columnspan=2, sticky=N+S+E+W)
		cursor.execute("SELECT link FROM substitute WHERE id ="+get_index_substitute)
		data_susbstitute = cursor.fetchall()
		data_susbstitute = [d[0] for d in data_susbstitute]
		data_link_susbtitute = tk.Label(second_window, text= data_susbstitute, wraplength=350, bg="#FAFAFA").grid(row=8, column=6, columnspan=2, sticky=N+S+E+W)
